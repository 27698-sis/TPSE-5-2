...
// ============================================
// SINCRONIZACIÓN Y CONECTIVIDAD (SILENCIOSA)
// ============================================
    ...
    Modal.open(project.title, `
        <div class="project-detail">
            ...
            <div class="detail-actions" style="display: flex; gap: 1rem;">
                ...
                <button class="btn-secondary" onclick="ProjectManager.deleteProject('${project.id}'); Modal.close();">Eliminar</button>
            </div>
        </div>
    `);
};
                ...
                registration.addEventListener('updatefound', () => {
                    ...
                    newWorker.addEventListener('statechange', () => {
                        if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                            Toast.info('Nueva versión disponible. Recargá para actualizar.');
                        }
                    });
                });
            })
